...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Reverse layout so as to display the most recent post at the top
    ...
    private void updateUI(final FirebaseUser currentUser) {
        //create and initialize a instance of Query that retrieves all posts uploaded
        ...
        FirebaseRecyclerOptions<Attic> options = new FirebaseRecyclerOptions.Builder<Attic>().setQuery(query, new SnapshotParser<Attic>() {
            ...
            @NotNull
            @Override
            public Attic parseSnapshot(@NonNull @NotNull DataSnapshot snapshot) {
        ...
        //create firebase adapter passing in the model, and a View Holder
        ...
        //Complete all the steps n the atticView Holder before proceeding to the methods onCreateViewHolder, and onBindViewHolder
        ...
        adapter = new FirebaseRecyclerAdapter<Attic, AtticViewHolder>(options){
            ...
            @NonNull
            @Override
            public AtticViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_items,parent,false);
                return new AtticViewHolder(view);
            }

            @Override
            protected void onBindViewHolder(@NonNull @NotNull AtticViewHolder holder, int position, @NonNull @NotNull Attic model) {
                ...
                //add on click listener on particular post to allow opening this post on a different screen
    ...
    //Declare the view objects in the card view
        ...
        public AtticViewHolder(@NonNull @NotNull View itemView) {
            super(itemView);
        ...
        public void setDate(String date){
            ...
            //want to know who has liked particular post
            FirebaseUser user = FirebaseAuth.getInstance().getCurrentUser();
            if (user !=null){
                currentUserID = user.getUid();
            }else{
            ...
            //Listen to changes inDB ref of likes
            likesRef.addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(@androidx.annotation.NonNull @NotNull DataSnapshot snapshot) {
                    if(snapshot.child(post_key).hasChild(currentUserID)){
...
/*public class MainActivity extends AppCompatActivity  {
    ...
    private void updateUI(final FirebaseUser currentUser) {
        ...
        FirebaseRecyclerOptions<Attic> options = new FirebaseRecyclerOptions.Builder<Attic>().
                setQuery(query, new SnapshotParser<Attic>() { //debug
                    @NonNull
                    @Override
                    //Create a snapshot of your model
                    public Attic parseSnapshot(@NonNull DataSnapshot snapshot) {
                        final Attic attic = new Attic(snapshot.child("title").getValue().toString(),
                                snapshot.child("desc").getValue().toString(),
                                snapshot.child("postImage").getValue().toString(),
                                currentUser.getDisplayName(),
                                //snapshot.child("displayName").getValue().toString(), //debug
                                //Attempt to invoke virtual method 'java.lang.String java.lang.Object.toString()' on a null object reference
                                //        at com.example.attic.MainActivity$1.parseSnapshot
        ...
        //Then implement the methods onCreateViewHolder and onBindViewHolder
        // Complete all the steps in the AtticViewHolder
        // before proceeding to the methods  onCreateViewHolder, and onBindViewHolder
        adapter = new FirebaseRecyclerAdapter<Attic, AtticViewHolder>(options) {
            @NonNull
            @Override
            ...
            protected void onBindViewHolder(@NonNull AtticViewHolder holder, int position, @NonNull  Attic model) {
                ...
                holder.post_layout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent singleActivity = new Intent(MainActivity.this, SinglePostActivity.class);
                        singleActivity.putExtra("PostID", post_key);   startActivity(singleActivity);
                    }
                });
                ...
                holder.likePostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        //Listen to changes in the likes database reference
                        likesRef.addValueEventListener(new ValueEventListener() {   @Override
